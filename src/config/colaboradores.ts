...
export const COLABORADORES: ColaboradorConfig[] = [
  ...
  // ── Aba: Pedro e Paulo ────────────────────────────────────────────────────
  { nomeDisplay: 'Pedro Sella',      nomeCompleto: 'PEDRO AUGUSTO SANCHES SELLA',          abaSheet: 'Pedro e Paulo' },
  { nomeDisplay: 'Paulo Oliveira',   nomeCompleto: 'PAULO VICTOR MOREIRA DE OLIVEIRA',     abaSheet: 'Pedro e Paulo' },
  // ── Aba: Thais ────────────────────────────────────────────────────────────
